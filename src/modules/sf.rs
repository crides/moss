...
use crate::math::{cgamma, gamma, lgamma, sgngamma};
...
fn eiPi(phi: f64, n: f64, m: f64) -> f64 {
    ...
    let mss = m * s * s;
    let nss = n * s * s;
    return s * RF(c * c, 1.0 - mss, 1.0)
        + 1.0 / 3.0 * nss * s * RJ(c * c, 1.0 - mss, 1.0, 1.0 - nss);
}
...
fn hurwitz_zeta(s: f64, a: f64) -> f64 {
    ...
    return y + Npa.powf(1.0 - s) / (s - 1.0) + 0.5 * Npa.powf(-s) + s * Npa.powf(-s - 1.0) / 12.0
...
fn sf_K(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        1 => {}
        n => return env.argc_error(n, 1, 1, "K"),
    }
    let m = match argv[0] {
...
fn sf_Pi(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        3 => {}
        n => return env.argc_error(n, 3, 3, "Pi"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_RF(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        3 => {}
        n => return env.argc_error(n, 3, 3, "RF"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_RC(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "RC"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_RJ(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        4 => {}
        n => return env.argc_error(n, 4, 4, "RJ"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_RD(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        3 => {}
        n => return env.argc_error(n, 3, 3, "RD"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_PP(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        3 => {}
        n => return env.argc_error(n, 3, 3, "PP"),
    }
    let n = match argv[0] {
        Object::Int(x) => x,
...
fn sf_PH(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "PH"),
    }
    let n = match argv[0] {
        Object::Int(x) => x,
...
fn sf_PT(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "PT"),
    }
    let n = match argv[0] {
        Object::Int(x) => x,
...
fn sf_PU(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "PU"),
    }
    let n = match argv[0] {
        Object::Int(x) => x,
...
fn sf_gamma(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "gamma"),
    }
    let s = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_zeta(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        1 => {}
        n => return env.argc_error(n, 1, 1, "zeta"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_B(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        1 => {}
        n => return env.argc_error(n, 1, 1, "B"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
...
fn sf_Beta(env: &mut Env, _pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        2 => {}
        n => return env.argc_error(n, 2, 2, "Beta"),
    }
    let x = match argv[0] {
        Object::Int(x) => float(x),
        Object::Float(x) => x,
