...
use crate::object::{CharString, FnResult, Object};
use crate::vm::Env;
...
fn type_error0_string(env: &mut Env, id: &str, s: &Object) -> FnResult {
    env.type_error1(
        &format!("Type error in s.{}(): s is not a string.", id),
        "s",
        s,
    )
}

fn string_isdigit(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
...
fn string_isalpha(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "isalpha"),
    }
    match *pself {
        Object::String(ref s) => {
            for c in &s.data {
...
fn string_isalnum(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "isalnum"),
    }
    match *pself {
        Object::String(ref s) => {
            for c in &s.data {
...
fn string_isspace(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "isspace"),
    }
    match *pself {
        Object::String(ref s) => {
            for c in &s.data {
...
fn string_islower(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "islower"),
    }
    match *pself {
        Object::String(ref s) => {
            for c in &s.data {
...
fn string_isupper(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "isupper"),
    }
    match *pself {
        Object::String(ref s) => {
            for c in &s.data {
...
fn lower(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "lower"),
    }
    match *pself {
        Object::String(ref s) => {
...
fn upper(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    match argv.len() {
        0 => {}
        n => return env.argc_error(n, 0, 0, "upper"),
    }
    match *pself {
        Object::String(ref s) => {
            let mut v: Vec<char> = Vec::new();
...
fn ljust(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    ...
    let s = match *pself {
        ...
        _ => {
            return env.type_error1("Type error in s.ljust(n): s is not a string.", "s", pself);
        }
    };
    let n = match argv[0] {
        Object::Int(x) => {
        ...
        _ => {
            return env.type_error1("Type error in s.ljust(n): n is not an integer.", "s", pself);
        }
    };
...
fn rjust(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    ...
    let s = match *pself {
        Object::String(ref s) => &s.data,
        _ => {
            return env.type_error1("Type error in s.rjust(n): s is not a string.", "s", pself);
        }
    };
    let n = match argv[0] {
        Object::Int(x) => {
        ...
        _ => {
            return env.type_error1("Type error in s.rjust(n): n is not an integer.", "s", pself);
        }
    };
    let mut v: Vec<char> = Vec::new();
    for _ in s.len()..n {
...
fn string_ltrim(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    let s = match *pself {
        Object::String(ref s) => &s.data,
...
fn string_rtrim(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    let s = match *pself {
        Object::String(ref s) => &s.data,
...
fn string_trim(env: &mut Env, pself: &Object, argv: &[Object]) -> FnResult {
    let s = match *pself {
        Object::String(ref s) => &s.data,
        ...
        Object::String(ref s) => {
            if spec == "utf-8" {
                ...
                env.value_error(&format!(
                    "Value error in s.encode(spec): spec=='{}' is unknown.",
                    spec
                ))
            }
        }
        ref s => env.type_error1("Type error in s.encode(spec): s is not a string.", "s", s),
    }
}
